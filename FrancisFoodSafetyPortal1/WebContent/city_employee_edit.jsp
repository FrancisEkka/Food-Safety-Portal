...
<html lang="en">
<head>
<title>Edit city employee</title>
<meta charset="utf-8">
...
<section class="content gallery pad1">
  <div class="container">
      ...
      <div class="right_content">
          <a><h1 align="center"><font style="font-size: 16px">Edit city employee</font></h1></a><br/><br/><br/>
          <form name="f1" action="city_employee_edit_save" method="post">
