...
<html lang="en">
<head>
<title>Enter city employee</title>
<meta charset="utf-8">
...
<section class="content gallery pad1">
  <div class="container">
            ...
            <div class="sidebarmenu">
                ...
                <div class="submenu">
                    <ul>
                        ...
                        <li class="current2"><a href="entry_new_city_employee.jsp">City Employee</a></li>
                ...
                <div class="submenu">
                    ...
                    <li><a href="view_city_employee">City Employee</a></li>
                    <li><a href="view_sugg">Suggestions</a></li>
                    </ul>
                </div>
      ...
      <div class="right_content">
          <a><h1 align="center"><font style="font-size: 16px">New Entry Of City employee</font></h1></a><br/><br/><br/>
          <form name="f1" action="entry_new_city_emp" method="post">
                ...
                <fieldset>
                    ...
                    <dl>
                     ...
                     <dl>
                        ...
                        <dd><input type="email" name="email" id="email_id" size="54" onChange="email();" required /><font color="#FF0000"></font>						
						</dd>
                    </dl>
                     <dl>
