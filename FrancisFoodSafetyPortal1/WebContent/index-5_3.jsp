          ...
          <div class="navigation ">
            <nav>
              <ul class="sf-menu">
               ...
               <li class="current"><a href="index-5.jsp">Keep your food safe</a></li>
             </ul>
            </nav>       
            <div class="clear"></div>
          </div>
  ...
  <div class="container">
      <div class="left_content">
            ...
            <div class="sidebarmenu">
                ...
                <div class="submenu">
                   <ul>
                       <li><h2><a href="index-5.jsp">Keep Your Food Safe</a></h2></li>
                        <li><a href="index-5_1.jsp">Check Your Step</a></li>
                        <li><a href="index-5_2.jsp">Clean</a></li>
                        <li><a href="index-5_3.jsp">Separate</a></li>
                        <li><a href="index-5_4.jsp">Cook</a></li>
                        <li><a href="index-5_5.jsp">Chill</a></li>
                        <li><a href="index-5_6.jsp">Food Safety Myths Exposed</a></li>
                        <li><a href="index-5_7.jsp">Dangerous Food Safety Mistakes</a></li>
                        <li><a href="index-5_8.jsp">Food Safety Chats</a></li>
                        <li><a href="index-5_9.jsp">Food Poisoning</a></li>
                        <li><a href="index-5_10.jsp">An healthy Diet</a></li>
                        <li><a href="index-5_11.jsp">Diet by Age group</a></li>
                        <li><a href="index-5_12.jsp">who's at Risk</a></li>
                        <li><a href="index-5_13.jsp">What Government Does</a></li>
                    </ul>
                </div>
...
USDA's Food Safety and Inspection Service (FSIS) ensures that our nation's meat, poultry and processed egg supply is wholesome, safe and properly labeled. Through prevention-based policies and practices USDA is meeting the foodborne challenges of the 21st century head on and using science to craft the best ways forward. 
 ...
 <h2>Protecting Public Health and Preventing Foodborne Illness</h2>
 <p>
...
Learn how to Report a Problem with Food and what information to have available. 
 ...
 <h2>Enhancing Public Education and Outreach</h2>
 <p>
     
Operation of the USDA Meat and Poultry Hotline, the USDA Food Safety Discovery Zone traveling exhibit and the FSIS Web-based virtual representative Ask Karen are key components of USDA's consumer education programs. 
...
Additionally, USDA is requiring clearer product labels so consumers will know whether products they purchase contain added solutions that might not be apparent. USDA also recently began requiring nutrition labels on single-ingredient raw meat and poultry products to provide more information to consumers.
 ...
 <h2>Investing in Innovative Technology, Processes and Tools to Protect Public Health </h2>
 <p>
