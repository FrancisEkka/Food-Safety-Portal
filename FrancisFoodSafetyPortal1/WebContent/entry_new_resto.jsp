...
<section class="content gallery pad1">
  <div class="container">
                ...
                <div class="submenu">
                   <ul>
                       <li class="current1"><h2><a href="#">New Entries</a></h2></li>
                        ...
                        <li class="current2"><a href="entry_new_resto.jsp">Restaurants</a></li>
                    </ul>
                </div>
                <br/><br/>
                <div class="submenu">
      ...
      <div class="right_content">
          <a><h1 align="center"><font style="font-size: 16px">New Entry Of Restaurant</font></h1></a><br/><br/><br/>
          <form name="f1" action="entry_new_resto" method="post">
                ...
                <fieldset>
                    ...
                    <dl>
                        ...
                        <dd><input type="text" name="contact" id="contact_id" pattern="[0-9]{10}" size="54" maxlength="10" required title="valid mobile no"/><font color="#FF0000"></font>
						</dd>
                    </dl>
                     <dl>
