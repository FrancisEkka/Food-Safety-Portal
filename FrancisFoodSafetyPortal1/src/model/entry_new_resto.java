...
@WebServlet(name = "entry_new_resto", urlPatterns = {"/entry_new_resto"})
public class entry_new_resto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
            ...
            Logger.getLogger(entry_new_resto.class.getName()).log(Level.SEVERE, null, ex);
        }
            out.println("<center><h1><font color=\"blue\">Restaurant entered successfully<font></h1></center>");
            RequestDispatcher reqd;
            reqd = request.getRequestDispatcher("entry_new_resto.jsp");
