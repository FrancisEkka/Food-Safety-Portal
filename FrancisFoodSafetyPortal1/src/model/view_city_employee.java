...
@WebServlet(name = "view_city_employee", urlPatterns = {"/view_city_employee"})
public class view_city_employee extends HttpServlet {
...
"                    <li class=\"current2\"><a href=\"view_resto\">Restaurants</a></li>\n" +
...
"              </tr>\n" );
            ...
            Logger.getLogger(view_city_employee.class.getName()).log(Level.SEVERE, null, ex);
        }
        out.println("          </table>\n" +
"      </div>\n" +
"  </div>\n" +
